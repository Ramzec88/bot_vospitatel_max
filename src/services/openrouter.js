...
Язык — профессиональный, доступный воспитателям. Объём — 300–400 слов. Текст должен быть компактным и практичным.`,
...
Объём — 300–400 слов. Текст должен быть компактным и практичным.`,
...
Объём — 250–350 слов. Текст должен быть компактным и практичным.`,
};
